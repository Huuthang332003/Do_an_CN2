...
from networks.models import DenseNet121, DenseNet161, ResNet101
...
parser.add_argument('--root_path', type=str, default='../../', help='dataset root dir')
parser.add_argument('--csv_file_train', type=str, default='../data/Sipakmed/Train.csv', help='training set csv file')
parser.add_argument('--csv_file_val', type=str, default='../data/Sipakmed/Val.csv', help='validation set csv file')
parser.add_argument('--csv_file_test', type=str, default='../data/Sipakmed/Test.csv', help='testing set csv file')
parser.add_argument('--exp', type=str,  default='semi', help='model_name')
...
parser.add_argument('--labeled_num', type=int, default=568, help='number of labeled')
...
if __name__ == "__main__":
    ...
    def create_model(ema=False):
        # Network definition
        net = ResNet101(out_size=dataset.N_CLASSES, mode=args.label_uncertainty, drop_rate=args.drop_rate)
    ...
    unlabeled_idxs = list(range(args.labeled_num, 2839))
...
#      # Sử dụng hàm entropy minimization 
#     elif args.consistency_type == 'entropy':
#         consistency_criterion = losses.entropy_minimization_loss     
    else:
