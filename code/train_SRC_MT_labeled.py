...
parser.add_argument('--csv_file_train', type=str, default='../data/WSI/Train.csv', help='training set csv file')
parser.add_argument('--csv_file_val', type=str, default='../data/WSI/Val.csv', help='validation set csv file')
parser.add_argument('--csv_file_test', type=str, default='../data/WSI/Test.csv', help='testing set csv file')
parser.add_argument('--exp', type=str,  default='fully', help='model_name')
...
parser.add_argument('--labeled_bs', type=int, default=1049, help='number of labeled data per batch')
...
parser.add_argument('--labeled_num', type=int, default=1049, help='number of labeled')
